      ...
      <div className="flex h-screen overflow-hidden">
            ...
            {steps.map((step, i) => {
              ...
              return (
                <button
                  ...
                  className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl transition-all ${currentStep === i
        ...
        <div className="hidden md:flex flex-1 bg-slate-100 items-start justify-center overflow-y-auto p-12 custom-scrollbar relative scroll-smooth">
          <div className="w-full max-w-5xl relative z-10 flex justify-center py-20">
            <div className={`transition-all duration-500 origin-top shadow-[0_40px_100px_-20px_rgba(0,0,0,0.3)] ${isPreviewZoomed
              ? "scale-100"
