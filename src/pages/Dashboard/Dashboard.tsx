      ...
      <main className="max-w-[1600px] mx-auto px-8 py-10 space-y-12 relative z-10">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-black uppercase tracking-tighter">Recent Strategic Assets</h3>
            <Badge variant="outline" className="border-white/10 rounded-full px-4 py-1 uppercase text-[9px] font-black tracking-widest text-primary bg-primary/5">
              Live Monitoring
            </Badge>
          </div>
                    ...
                    >
                      ...
                      <td className="p-6 pr-10 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Button variant="ghost" size="icon" onClick={() => navigate(`/preview/${p.id}`, { state: { proposal: p } })} className="w-10 h-10 rounded-xl hover:bg-primary/10 text-primary transition-all active:scale-90">
