       ...
       <div className="relative z-10 flex justify-between items-start">
          ...
          <div className="text-right space-y-4">
             <div className="space-y-3">
                <div className="text-[9px] font-black uppercase tracking-[0.4em] text-white/30">Proposal ID</div>
       ...
       <div className="relative z-10 mt-auto pb-6 w-full">
          ...
          <div className="grid grid-cols-2 gap-4 px-2">
             ...
             <div className="space-y-3 border-l pl-6 border-white/10">
                <div className="text-[8px] font-black uppercase tracking-[0.4em] text-white/30">Proposal Date</div>
